...
public class EventsControllerTest {
	...
	public void searchEvents() throws Exception {
		...
		mvc.perform(get("/search").accept(MediaType.TEXT_HTML).param("inputSearch", "bean")).andExpect(status().isOk())
	...
	public void searchNoEvents() throws Exception {
		...
		mvc.perform(get("/search").accept(MediaType.TEXT_HTML).param("inputSearch", "beanSequel")).andExpect(status().isOk())
			.andExpect(view().name("events/index")).andExpect(handler().methodName("searchEvent"));
	}
}
